...
// ==================== 参保资助档次配置路由组 ====================
Router::addGroup('/api/insurance-level-configs', function () {
    // 具体路径要在参数路径之前
...
// ==================== 参保数据管理路由组 ====================
Router::addGroup('/api/insurance-data', function () {
    // 具体路径要在参数路径之前
...
// ==================== 税务汇总路由组 ====================
Router::addGroup('/api/tax-summary', function () {
    Router::get('/data', [App\Controller\TaxSummaryController::class, 'getData']);
    Router::get('/export', [App\Controller\TaxSummaryController::class, 'export']);
});

// ==================== 参保汇总路由组 ====================
Router::addGroup('/api/insurance-summary', function () {
    Router::get('/data', [App\Controller\InsuranceSummaryController::class, 'getData']);
    Router::get('/export', [App\Controller\InsuranceSummaryController::class, 'export']);
});

// ==================== 统计汇总路由组 ====================
Router::addGroup('/api/statistics', function () {
    // 项目管理
...
// ==================== 医疗救助路由组 ====================
Router::addGroup('/api/medical-assistance', function () {
    // 患者管理
...
Router::addGroup('/api', function () {
    ...
    // OCR识别相关路由
    Router::post('/ocr/recognize', [App\Controller\OcrController::class, 'recognize']);
    Router::get('/ocr/history', [App\Controller\OcrController::class, 'getHistory']);

    // 身份验证相关路由
    Router::post('/identity-verification/verify', [App\Controller\IdentityVerificationController::class, 'verify']);
    Router::get('/identity-verification/history', [App\Controller\IdentityVerificationController::class, 'getHistory']);
