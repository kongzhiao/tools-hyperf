...
class InitMenuPermissionsCommand extends HyperfCommand
{
    ...
    private function permissionDefinitions(): array
    {
        return [
            ...
            ['name' => '业务配置', 'description' => '业务配置（配置已归入所属业务模块）', 'type' => 'menu', 'parent' => null, 'path' => '/business-config', 'component' => null, 'icon' => 'SettingOutlined', 'sort' => 3, 'status' => 0],
            ...
            ['name' => '联网结算', 'description' => '联网结算', 'type' => 'menu', 'parent' => null, 'path' => '/yf', 'component' => null, 'icon' => 'GlobalOutlined', 'sort' => 20, 'status' => 1],
            ...
            ['name' => '类别转换配置', 'description' => '数据核实类别转换配置', 'type' => 'menu', 'parent' => '数据核实', 'path' => '/data-verification/category-conversion', 'component' => '@/pages/BussinessConfig/CategoryConversion', 'icon' => 'SwapOutlined', 'sort' => 5, 'status' => 1],
            ['name' => '参保档次配置', 'description' => '数据核实参保档次配置', 'type' => 'menu', 'parent' => '数据核实', 'path' => '/data-verification/insurance-level-config', 'component' => '@/pages/BussinessConfig/InsuranceLevelConfig', 'icon' => 'ToolOutlined', 'sort' => 6, 'status' => 1],

            ['name' => '联网结算明细', 'description' => '联网结算明细', 'type' => 'menu', 'parent' => '联网结算', 'path' => '/yf/settlement-online', 'component' => '@/pages/YfSettlement/Online', 'icon' => 'GlobalOutlined', 'sort' => 1, 'status' => 1],
            ['name' => '类别额度配置', 'description' => '联网结算类别额度配置', 'type' => 'menu', 'parent' => '联网结算', 'path' => '/yf/category-money-config', 'component' => '@/pages/BussinessConfig/CategoryMoneyConfig', 'icon' => 'SettingOutlined', 'sort' => 2, 'status' => 1],
            ...
            ['name' => '应补应退明细', 'description' => '应补应退明细', 'type' => 'menu', 'parent' => '未救助台账', 'path' => '/unrescued/refund-records', 'component' => '@/pages/Unrescued/RefundRecords', 'icon' => 'AuditOutlined', 'sort' => 2, 'status' => 1],
            ['name' => '下放通知', 'description' => '下放通知', 'type' => 'menu', 'parent' => '未救助台账', 'path' => '/unrescued/notice-records', 'component' => '@/pages/Unrescued/NoticeRecords', 'icon' => 'SendOutlined', 'sort' => 3, 'status' => 1],
            ['name' => '重大疾病编码', 'description' => '重大疾病编码', 'type' => 'menu', 'parent' => '未救助台账', 'path' => '/unrescued/disease-configs', 'component' => '@/pages/Unrescued/DiseaseConfigs', 'icon' => 'MedicineBoxOutlined', 'sort' => 4, 'status' => 1],
            ...
            ['name' => '联网结算:查看', 'description' => '查看联网结算列表', 'type' => 'operation', 'parent' => '联网结算明细', 'sort' => 1, 'status' => 1],
            ['name' => '联网结算:导入', 'description' => '导入结算数据', 'type' => 'operation', 'parent' => '联网结算明细', 'sort' => 2, 'status' => 1],
            ['name' => '联网结算:导出明细', 'description' => '导出联网结算明细数据', 'type' => 'operation', 'parent' => '联网结算明细', 'sort' => 3, 'status' => 1],
            ['name' => '联网结算:导出台账', 'description' => '导出联网结算台账数据', 'type' => 'operation', 'parent' => '联网结算明细', 'sort' => 4, 'status' => 1],
            ['name' => '联网结算:标记', 'description' => '标记支付状态', 'type' => 'operation', 'parent' => '联网结算明细', 'sort' => 5, 'status' => 1],
            ['name' => '联网结算:删除', 'description' => '物理/逻辑删除数据', 'type' => 'operation', 'parent' => '联网结算明细', 'sort' => 6, 'status' => 1],
            ['name' => '联网结算:重算', 'description' => '重新计算补助金额', 'type' => 'operation', 'parent' => '联网结算明细', 'sort' => 7, 'status' => 0],
            ...
            ['name' => '未救助明细:导出', 'description' => '导出未救助明细', 'type' => 'operation', 'parent' => '未救助明细', 'sort' => 73, 'status' => 1],
            ['name' => '应补应退明细:查看', 'description' => '查看应补应退明细', 'type' => 'operation', 'parent' => '应补应退明细', 'sort' => 74, 'status' => 1],
            ['name' => '应补应退明细:导入', 'description' => '导入应补应退明细', 'type' => 'operation', 'parent' => '应补应退明细', 'sort' => 75, 'status' => 1],
            ['name' => '应补应退明细:清洗', 'description' => '执行应补应退清洗', 'type' => 'operation', 'parent' => '应补应退明细', 'sort' => 76, 'status' => 1],
            ['name' => '应补应退明细:导出', 'description' => '导出应补应退明细', 'type' => 'operation', 'parent' => '应补应退明细', 'sort' => 77, 'status' => 1],
            ['name' => '下放通知:查看', 'description' => '查看下放通知', 'type' => 'operation', 'parent' => '下放通知', 'sort' => 78, 'status' => 1],
            ['name' => '下放通知:导入', 'description' => '导入下放通知', 'type' => 'operation', 'parent' => '下放通知', 'sort' => 79, 'status' => 1],
            ['name' => '下放通知:下放', 'description' => '批量下放通知', 'type' => 'operation', 'parent' => '下放通知', 'sort' => 80, 'status' => 1],
            ['name' => '下放通知:回填', 'description' => '回填通知信息', 'type' => 'operation', 'parent' => '下放通知', 'sort' => 81, 'status' => 1],
            ['name' => '下放通知:报销标记', 'description' => '标记报销状态', 'type' => 'operation', 'parent' => '下放通知', 'sort' => 82, 'status' => 1],
            ['name' => '下放通知:备注', 'description' => '填写管理员备注', 'type' => 'operation', 'parent' => '下放通知', 'sort' => 83, 'status' => 1],
            ['name' => '下放通知:导出', 'description' => '导出通知明细', 'type' => 'operation', 'parent' => '下放通知', 'sort' => 84, 'status' => 1],
            ['name' => '重大疾病编码:查看', 'description' => '查看重大疾病编码', 'type' => 'operation', 'parent' => '重大疾病编码', 'sort' => 85, 'status' => 1],
            ['name' => '重大疾病编码:创建', 'description' => '创建重大疾病编码', 'type' => 'operation', 'parent' => '重大疾病编码', 'sort' => 86, 'status' => 1],
            ['name' => '重大疾病编码:编辑', 'description' => '编辑重大疾病编码', 'type' => 'operation', 'parent' => '重大疾病编码', 'sort' => 87, 'status' => 1],
            ['name' => '重大疾病编码:删除', 'description' => '删除重大疾病编码', 'type' => 'operation', 'parent' => '重大疾病编码', 'sort' => 88, 'status' => 1],
            ['name' => '重大疾病编码:导入', 'description' => '导入重大疾病编码', 'type' => 'operation', 'parent' => '重大疾病编码', 'sort' => 89, 'status' => 1],
            ...
            ['name' => '参保台账明细:下放', 'description' => '下放参保台账给镇街核实', 'type' => 'operation', 'parent' => '参保台账明细', 'sort' => 95, 'status' => 1],
            ['name' => '参保台账明细:收回', 'description' => '收回参保台账镇街填报权限', 'type' => 'operation', 'parent' => '参保台账明细', 'sort' => 96, 'status' => 1],
            ['name' => '参保台账明细:下放批次', 'description' => '查看参保台账下放批次', 'type' => 'operation', 'parent' => '参保台账明细', 'sort' => 97, 'status' => 1],
            ['name' => '参保配置:查看', 'description' => '查看参保配置', 'type' => 'operation', 'parent' => '参保配置', 'sort' => 98, 'status' => 1],
            ['name' => '参保配置:导入', 'description' => '导入参保配置', 'type' => 'operation', 'parent' => '参保配置', 'sort' => 99, 'status' => 1],
            ['name' => '参保配置:创建', 'description' => '创建参保配置', 'type' => 'operation', 'parent' => '参保配置', 'sort' => 100, 'status' => 1],
            ['name' => '参保配置:编辑', 'description' => '编辑参保配置', 'type' => 'operation', 'parent' => '参保配置', 'sort' => 101, 'status' => 1],
            ['name' => '参保配置:删除', 'description' => '删除参保配置', 'type' => 'operation', 'parent' => '参保配置', 'sort' => 102, 'status' => 1],
            ['name' => '参保导入记录:查看', 'description' => '查看参保导入记录', 'type' => 'operation', 'parent' => '参保导入记录', 'sort' => 103, 'status' => 1],
        ];
    }
}
